...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 shrink-0 bg-[var(--color-bg)]">
      <div className="mx-auto w-full max-w-[1380px] px-[var(--site-gutter)]">
        <div className="grid min-h-28 grid-cols-[auto_1fr] items-center gap-6 xl:grid-cols-[470px_minmax(0,820px)] xl:gap-16 2xl:gap-20">
          <Link
            href="/"
            className={[
