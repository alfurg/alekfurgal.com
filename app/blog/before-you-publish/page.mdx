...
export const article = {
  order: 1,
  heading: "Before you publish another article, ask yourself these questions",
  subheading: "A practical framework for deciding whether a page deserves a place in your content system.",
  status: "published",
